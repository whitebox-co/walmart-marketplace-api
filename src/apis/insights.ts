...
export interface GetUnpublishedItemsPayload {
  ...
  /**
   *
   * @type {InlineResponse2003ScoreDetailsOfferPrice}
   * @memberof GetUnpublishedItemsPayload
   */
  marketPrice?: InlineResponse2003ScoreDetailsOfferPrice;
  /**
   ...
   * @memberof GetUnpublishedItemsPayload
   */
  price?: InlineResponse2003ScoreDetailsOfferPrice;
  /**
 ...
 *
 * @export
 * @interface InlineResponse2003ScoreDetailsOfferPrice
 */
export interface InlineResponse2003ScoreDetailsOfferPrice {
  /**
   * The numerical value of the price
   * @type {string}
   * @memberof InlineResponse2003ScoreDetailsOfferPrice
   */
  amount?: string;
  /**
   * The currency type
