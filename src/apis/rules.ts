...
export interface AreaEntity {
    /**
     * states.
     * @type {Array<InlineResponse2007PayloadStates>}
     * @memberof AreaEntity
     */
    states?: Array<InlineResponse2007PayloadStates>;
    /**
     * regionCode
     * @type {string}
     * @memberof AreaEntity
...
export interface CategoryInfo {
    ...
    /**
     * subCategory
     * @type {Array<InlineResponse2009Subcategory>}
     * @memberof CategoryInfo
     */
    subcategory?: Array<InlineResponse2009Subcategory>;
}
/**
 * 
 * @export
...
export interface CreateRuleResponse {
    /**
     * 
     * @type {Array<InlineResponse200Rules>}
     * @memberof CreateRuleResponse
     */
    rules?: Array<InlineResponse200Rules>;
    /**
     * 
     * @type {string}
     * @memberof CreateRuleResponse
...
export interface GetAllAreasPayload {
    /**
     * 
     * @type {Array<InlineResponse2007PayloadEntities>}
     * @memberof GetAllAreasPayload
     */
    entities?: Array<InlineResponse2007PayloadEntities>;
}
/**
 * 
 * @export
 ...
 * @export
 * @interface InlineResponse2001RuleAction
 */
export interface InlineResponse2001RuleAction {
    /**
     * List of two-day regions.
     * @type {Array<InlineResponse2001RuleActionTwoDayShippingRegions>}
     * @memberof InlineResponse2001RuleAction
     */
    twoDayShippingRegions?: Array<InlineResponse2001RuleActionTwoDayShippingRegions>;
}
/**
 * 
 * @export
 * @interface InlineResponse2001RuleActionSubRegions
 */
export interface InlineResponse2001RuleActionSubRegions {
    /**
     * subRegionCode
     * @type {string}
     * @memberof InlineResponse2001RuleActionSubRegions
     */
 ...
 * List of two-day regions.
 * @export
 * @interface InlineResponse2001RuleActionTwoDayShippingRegions
 */
export interface InlineResponse2001RuleActionTwoDayShippingRegions {
    /**
     * regionCode
     * @type {string}
     * @memberof InlineResponse2001RuleActionTwoDayShippingRegions
     */
    regionCode?: string;
    /**
     * 
     * @type {Array<InlineResponse2001RuleActionSubRegions>}
     * @memberof InlineResponse2001RuleActionTwoDayShippingRegions
     */
    subRegions?: Array<InlineResponse2001RuleActionSubRegions>;
}
/**
 * 
 * @export
...
export interface InlineResponse2001Rules {
    ...
    /**
     * 
     * @type {InlineResponse2001RuleAction}
     * @memberof InlineResponse2001Rules
     */
    ruleAction?: InlineResponse2001RuleAction;
}
/**
 * 
 * @export
 ...
 * 
 * @export
 * @interface InlineResponse2007PayloadEntities
 */
export interface InlineResponse2007PayloadEntities {
    /**
     * states.
     * @type {Array<InlineResponse2007PayloadStates>}
     * @memberof InlineResponse2007PayloadEntities
     */
    states?: Array<InlineResponse2007PayloadStates>;
    /**
     * regionCode
 ...
 * statesubregions
 * @export
 * @interface InlineResponse2007PayloadStateSubregions
 */
export interface InlineResponse2007PayloadStateSubregions {
    /**
     * stateSubregionCode
     * @type {string}
     * @memberof InlineResponse2007PayloadStateSubregions
     */
 ...
 * states.
 * @export
 * @interface InlineResponse2007PayloadStates
 */
export interface InlineResponse2007PayloadStates {
    /**
     * statesubregions
     * @type {Array<InlineResponse2007PayloadStateSubregions>}
     * @memberof InlineResponse2007PayloadStates
     */
    stateSubregions?: Array<InlineResponse2007PayloadStateSubregions>;
}
/**
 * 
 * @export
 ...
 * subCategory
 * @export
 * @interface InlineResponse2009Subcategory
 */
export interface InlineResponse2009Subcategory {
    /**
     * Name of specific kind of category
     * @type {string}
     * @memberof InlineResponse2009Subcategory
     */
 ...
 * 
 * @export
 * @interface InlineResponse200Rules
 */
export interface InlineResponse200Rules {
    /**
     * Seller creates conditions while defining the custom rule assortment.There are three condition which a seller can use : subCategories, price, weight.
     * @type {Array<V3RulesCreateRulesConditions>}
     * @memberof InlineResponse200Rules
     */
    conditions?: Array<V3RulesCreateRulesConditions>;
    /**
     * Description of the rule created for custom rule assortment.
...
export interface RuleToUpdate {
    ...
    /**
     * Defines the two day state coverage areas.
     * @type {Array<InlineResponse2001RuleAction>}
     * @memberof RuleToUpdate
     */
    actions?: Array<InlineResponse2001RuleAction>;
}
/**
 * states.
 * @export
...
export const RulesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        activateRule: async (authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject2: InlineObject2, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('activateRule', 'inlineObject2', inlineObject2)
         ...
         * @throws {RequiredError}
         */
        createItemRule: async (authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject: InlineObject, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        createOverrideExceptions: async (authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject5: InlineObject5, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            ...
            assertParamExists('createOverrideExceptions', 'inlineObject5', inlineObject5)
         ...
         * @throws {RequiredError}
         */
        deleteExceptions: async (authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject4: InlineObject4, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            ...
            assertParamExists('deleteExceptions', 'inlineObject4', inlineObject4)
            const localVarPath = `/v3/rules/exceptions`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        inactivateRule: async (authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject3: InlineObject3, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            ...
            assertParamExists('inactivateRule', 'inlineObject3', inlineObject3)
         ...
         * @throws {RequiredError}
         */
        updateRule: async (authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject1: InlineObject1, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateShippingAreaToRule: async (authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject6: InlineObject6, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            ...
            assertParamExists('updateShippingAreaToRule', 'inlineObject6', inlineObject6)
...
export const RulesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async activateRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject2: InlineObject2, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2002>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.activateRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject2, wMCONSUMERCHANNELTYPE, options);
         ...
         * @throws {RequiredError}
         */
        async changeAssortmentType(enable: boolean, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, body: object, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20010>> {
         ...
         * @throws {RequiredError}
         */
        async createItemRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject: InlineObject, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createItemRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This API is used if any SKU is required to be removed from Two-day delivery settings
         ...
         * @throws {RequiredError}
         */
        async createOverrideExceptions(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject5: InlineObject5, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2006>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createOverrideExceptions(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject5, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This API is used to bring back any SKU to Two-day Delivery settings.
         ...
         * @throws {RequiredError}
         */
        async deleteExceptions(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject4: InlineObject4, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2006>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteExceptions(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject4, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This API is used to delete a rule for a specific ruleId and ruleStatus
         ...
         * @throws {RequiredError}
         */
        async deleteRule(ruleId: string, ruleStatus: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2003>> {
         ...
         * @throws {RequiredError}
         */
        async getAllAreas(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2007>> {
         ...
         * @throws {RequiredError}
         */
        async getAllExceptions(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2005>> {
         ...
         * @throws {RequiredError}
         */
        async getAllSubCategories(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2009>> {
         ...
         * @throws {RequiredError}
         */
        async getSimulationResult(ruleId: string, ruleStatus: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2008>> {
         ...
         * @throws {RequiredError}
         */
        async inactivateRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject3: InlineObject3, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2004>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.inactivateRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject3, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This API updates a rule defined using \"create an Item rule\". You can update priority, Description, conditions and name of a rule.
         ...
         * @throws {RequiredError}
         */
        async updateRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject1: InlineObject1, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2001>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject1, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This API helps you define coverage areas for your items that are held outside of the fulfillment centers defined by your shipNode management API\'s.
         ...
         * @throws {RequiredError}
         */
        async updateShippingAreaToRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject6: InlineObject6, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2001>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateShippingAreaToRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject6, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const RulesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        activateRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject2: InlineObject2, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2002> {
            return localVarFp.activateRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject2, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * This API helps you enable or disable the two-day assortment type.
         * @summary Change assortment type
         ...
         * @throws {RequiredError}
         */
        changeAssortmentType(enable: boolean, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, body: object, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse20010> {
         ...
         * @throws {RequiredError}
         */
        createItemRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject: InlineObject, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse200> {
            return localVarFp.createItemRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * This API is used if any SKU is required to be removed from Two-day delivery settings
         * @summary Create override exceptions
         ...
         * @throws {RequiredError}
         */
        createOverrideExceptions(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject5: InlineObject5, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2006> {
            return localVarFp.createOverrideExceptions(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject5, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * This API is used to bring back any SKU to Two-day Delivery settings.
         * @summary Delete exceptions
         ...
         * @throws {RequiredError}
         */
        deleteExceptions(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject4: InlineObject4, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2006> {
            return localVarFp.deleteExceptions(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject4, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * This API is used to delete a rule for a specific ruleId and ruleStatus
         * @summary Delete rule
         ...
         * @throws {RequiredError}
         */
        deleteRule(ruleId: string, ruleStatus: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2003> {
         ...
         * @throws {RequiredError}
         */
        getAllAreas(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2007> {
         ...
         * @throws {RequiredError}
         */
        getAllExceptions(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2005> {
         ...
         * @throws {RequiredError}
         */
        getAllSubCategories(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2009> {
         ...
         * @throws {RequiredError}
         */
        getSimulationResult(ruleId: string, ruleStatus: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2008> {
         ...
         * @throws {RequiredError}
         */
        inactivateRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject3: InlineObject3, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2004> {
            return localVarFp.inactivateRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject3, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * This API updates a rule defined using \"create an Item rule\". You can update priority, Description, conditions and name of a rule.
         * @summary Update rule
         ...
         * @throws {RequiredError}
         */
        updateRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject1: InlineObject1, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2001> {
            return localVarFp.updateRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject1, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * This API helps you define coverage areas for your items that are held outside of the fulfillment centers defined by your shipNode management API\'s.
         * @summary Update shipping area to rules
         ...
         * @throws {RequiredError}
         */
        updateShippingAreaToRule(authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, inlineObject6: InlineObject6, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2001> {
            return localVarFp.updateShippingAreaToRule(authorization, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, inlineObject6, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
    };
};
