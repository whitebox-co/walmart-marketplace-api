...
export const ItemsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getAnItem: async (
      ...
      const localVarPath = `/v3/items/{id}`.replace(
        `{${"id"}}`,
    ...
    retireAnItem: async (
      ...
      const localVarPath = `/v3/items/{SKU}`.replace(
        `{${"SKU"}}`,
  ...
  return {
    ...
    async getAnItem(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<InlineResponse200ItemResponse>
    > {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getCatalogSearch(
          authorization,
          wMSECACCESSTOKEN,
          wMQOSCORRELATIONID,
          wMSVCNAME,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getCountByStatus(
          authorization,
          wMSECACCESSTOKEN,
          wMQOSCORRELATIONID,
          wMSVCNAME,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getItemAssociations(
          authorization,
          wMSECACCESSTOKEN,
          wMQOSCORRELATIONID,
          wMSVCNAME,
...
export interface ItemsApiItemBulkUploadsRequest {
  /**
   * The feed Type
   * @type {'item' | 'RETIRE_ITEM' | 'MP_ITEM' | 'MP_WFS_ITEM' | 'MP_ITEM_MATCH' | 'MP_MAINTENANCE' | 'SKU_TEMPLATE_MAP' | 'SHIPPING_OVERRIDES'}
...
export class ItemsApi extends BaseAPI {
   ...
   */
  public getAllItems(
    requestParameters: ItemsApiGetAllItemsRequest,
    options?: any
  ) {
  ...
  public getCatalogSearch(
    requestParameters: ItemsApiGetCatalogSearchRequest,
    options?: any
  ) {
    return ItemsApiFp(this.configuration)
      .getCatalogSearch(
  ...
  public getCountByStatus(
    requestParameters: ItemsApiGetCountByStatusRequest,
    options?: any
  ) {
    return ItemsApiFp(this.configuration)
      .getCountByStatus(
   ...
   * @memberof ItemsApi
   */
  public getItemAssociations(
    requestParameters: ItemsApiGetItemAssociationsRequest,
    options?: any
  ) {
    return ItemsApiFp(this.configuration)
      .getItemAssociations(
  ...
  public getSearchResult(
    requestParameters: ItemsApiGetSearchResultRequest,
    options?: any
  ) {
    return ItemsApiFp(this.configuration)
      .getSearchResult(
  ...
  public getTaxonomyResponse(
    requestParameters: ItemsApiGetTaxonomyResponseRequest,
    options?: any
  ) {
    return ItemsApiFp(this.configuration)
      .getTaxonomyResponse(
   ...
   * @memberof ItemsApi
   */
  public itemBulkUploads(
    requestParameters: ItemsApiItemBulkUploadsRequest,
    options?: any
  ) {
    return ItemsApiFp(this.configuration)
      .itemBulkUploads(
   ...
   */
  public retireAnItem(
    requestParameters: ItemsApiRetireAnItemRequest,
    options?: any
  ) {
    return ItemsApiFp(this.configuration)
      .retireAnItem(
