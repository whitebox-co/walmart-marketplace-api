...
export const OnRequestReportApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        downloadReport: async (requestId: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * @param {'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX'} reportType Specifies the report type for the request. For example, reportType&#x3D;ITEM creates an Item Report.
         ...
         * @throws {RequiredError}
         */
        generateReport: async (reportType: 'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX', reportVersion: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, contentType: string, wMCONSUMERCHANNELTYPE?: string, inlineObject?: InlineObject, options: any = {}): Promise<RequestArgs> => {
         ...
         * @param {'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX'} reportType Type of report for which the request is created. Example, ITEM for Item Report.
         * @param {string} wMSECACCESSTOKEN The access token retrieved in the Token API call
         * @param {string} wMQOSCORRELATIONID A unique ID which identifies each API call and used to track and debug issues; use a random generated GUID for this ID
         * @param {string} wMSVCNAME Walmart Service Name
         * @param {string} accept Only supported Media Type : application/json
         ...
         * @throws {RequiredError}
         */
        getRequestsStatus: async (reportType: 'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX', wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, reportVersion?: string, requestStatus?: 'RECEIVED' | 'INPROGRESS' | 'READY' | 'ERROR', requestSubmissionStartDate?: string, requestSubmissionEndDate?: string, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'reportType' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getSingleRequestStatus: async (requestId: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'requestId' is not null or undefined
...
export const OnRequestReportApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async downloadReport(requestId: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2003>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.downloadReport(requestId, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, wMCONSUMERCHANNELTYPE, options);
         ...
         * @throws {RequiredError}
         */
        async generateReport(reportType: 'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX', reportVersion: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, contentType: string, wMCONSUMERCHANNELTYPE?: string, inlineObject?: InlineObject, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2001>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.generateReport(reportType, reportVersion, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, contentType, wMCONSUMERCHANNELTYPE, inlineObject, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Fetches a list of all report requests for specified search criteria by using query parameters.  You can fetch details of report requests created in the last 30 days only.
         ...
         * @throws {RequiredError}
         */
        async getRequestsStatus(reportType: 'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX', wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, reportVersion?: string, requestStatus?: 'RECEIVED' | 'INPROGRESS' | 'READY' | 'ERROR', requestSubmissionStartDate?: string, requestSubmissionEndDate?: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRequestsStatus(reportType, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, reportVersion, requestStatus, requestSubmissionStartDate, requestSubmissionEndDate, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Fetches status and other details of a report request by providing a requestID.  You can fetch details of report request created in the last 30 days only.
         ...
         * @throws {RequiredError}
         */
        async getSingleRequestStatus(requestId: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2002>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSingleRequestStatus(requestId, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, wMCONSUMERCHANNELTYPE, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const OnRequestReportApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        downloadReport(requestId: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2003> {
            return localVarFp.downloadReport(requestId, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a new request for report by specifying the reportType and reportVersion.
         * @summary Create Report Request
         ...
         * @throws {RequiredError}
         */
        generateReport(reportType: 'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX', reportVersion: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, contentType: string, wMCONSUMERCHANNELTYPE?: string, inlineObject?: InlineObject, options?: any): AxiosPromise<InlineResponse2001> {
            return localVarFp.generateReport(reportType, reportVersion, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, contentType, wMCONSUMERCHANNELTYPE, inlineObject, options).then((request) => request(axios, basePath));
        },
        /**
         * Fetches a list of all report requests for specified search criteria by using query parameters.  You can fetch details of report requests created in the last 30 days only.
         * @summary Get All Report Requests
        ...
        getRequestsStatus(reportType: 'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX', wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, reportVersion?: string, requestStatus?: 'RECEIVED' | 'INPROGRESS' | 'READY' | 'ERROR', requestSubmissionStartDate?: string, requestSubmissionEndDate?: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse200> {
            return localVarFp.getRequestsStatus(reportType, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, reportVersion, requestStatus, requestSubmissionStartDate, requestSubmissionEndDate, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
        /**
         * Fetches status and other details of a report request by providing a requestID.  You can fetch details of report request created in the last 30 days only.
         * @summary Report Request Status
         ...
         * @throws {RequiredError}
         */
        getSingleRequestStatus(requestId: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2002> {
            return localVarFp.getSingleRequestStatus(requestId, wMSECACCESSTOKEN, wMQOSCORRELATIONID, wMSVCNAME, accept, wMCONSUMERCHANNELTYPE, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface OnRequestReportApiGenerateReportRequest {
     ...
     * @type {'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX'}
     * @memberof OnRequestReportApiGenerateReport
     */
    readonly reportType: 'ITEM' | 'INVENTORY' | 'CANCELLATION' | 'DELIVERY_DEFECT' | 'ITEM_PERFORMANCE' | 'PROMO' | 'RETURN_OVERRIDES' | 'CPA' | 'SHIPPING_CONFIGURATION' | 'SHIPPING_PROGRAM' | 'FITMENT_MISSING_ATTR' | 'FITMENT_ACES_COVERAGE' | 'BUYBOX'
...
export class OnRequestReportApi extends BaseAPI {
    ...
    public getSingleRequestStatus(requestParameters: OnRequestReportApiGetSingleRequestStatusRequest, options?: any) {
        return OnRequestReportApiFp(this.configuration).getSingleRequestStatus(requestParameters.requestId, requestParameters.wMSECACCESSTOKEN, requestParameters.wMQOSCORRELATIONID, requestParameters.wMSVCNAME, requestParameters.accept, requestParameters.wMCONSUMERCHANNELTYPE, options).then((request) => request(this.axios, this.basePath));
    }
}
