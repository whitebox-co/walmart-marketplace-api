 ...
 * @export
 */
export const OnRequestReportApiAxiosParamCreator = function (
  ...
  return {
    ...
    getRequestsStatus: async (
      ...
      if (requestSubmissionStartDate !== undefined) {
        localVarQueryParameter["requestSubmissionStartDate"] =
          requestSubmissionStartDate;
      }

      if (requestSubmissionEndDate !== undefined) {
        localVarQueryParameter["requestSubmissionEndDate"] =
...
export const OnRequestReportApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    OnRequestReportApiAxiosParamCreator(configuration);
  return {
    /**
     * Fetches URL to download a generated report.
     * @summary Download Report URL
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getRequestsStatus(
          reportType,
          authorization,
          wMSECACCESSTOKEN,
          wMQOSCORRELATIONID,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getSingleRequestStatus(
          requestId,
          authorization,
          wMSECACCESSTOKEN,
          wMQOSCORRELATIONID,
...
export class OnRequestReportApi extends BaseAPI {
  ...
  public downloadReport(
    requestParameters: OnRequestReportApiDownloadReportRequest,
    options?: any
  ) {
  ...
  public generateReport(
    requestParameters: OnRequestReportApiGenerateReportRequest,
    options?: any
  ) {
    return OnRequestReportApiFp(this.configuration)
      .generateReport(
   ...
   * @memberof OnRequestReportApi
   */
  public getRequestsStatus(
    requestParameters: OnRequestReportApiGetRequestsStatusRequest,
    options?: any
  ) {
    return OnRequestReportApiFp(this.configuration)
      .getRequestsStatus(
   ...
   * @memberof OnRequestReportApi
   */
  public getSingleRequestStatus(
    requestParameters: OnRequestReportApiGetSingleRequestStatusRequest,
    options?: any
  ) {
    return OnRequestReportApiFp(this.configuration)
      .getSingleRequestStatus(
