...
// To parse this data:
//
//   import { Convert, MpItem43 } from "./file";
//
//   const mpItem43 = Convert.toMpItem43(json);
//
...
export enum ExternalProductIDType {
	Asin = 'ASIN',
}
...
export interface BooksMagazines {
	...
	additionalProductAttributes?: BooksMagazinesAdditionalProductAttribute[];
	...
	illustrator?: string;
	'ISBN-13'?: string[];
	isLargePrint?: MustShipAlone;
	isPrimaryVariant?: MustShipAlone;
	issue?: string;
	isUnabridged?: MustShipAlone;
	mainImageUrl: string;
	maximumRecommendedAge?: BooksMagazinesMaximumRecommendedAge;
	minimumRecommendedAge?: BooksMagazinesMinimumRecommendedAge;
	msrp?: number;
	...
	seriesTitle?: string;
	shortDescription: string;
	swatchImages?: BooksMagazinesSwatchImage[];
	title?: string;
	translatedFrom?: string;
	translator?: string;
	variantAttributeNames?: BooksMagazinesVariantAttributeName[];
	variantGroupId?: string;
}

export interface BooksMagazinesAdditionalProductAttribute {
	productAttributeName: string;
	productAttributeValue: string;
}
...
export interface BooksMagazinesMaximumRecommendedAge {
	measure?: number;
	unit?: MaximumRecommendedAgeUnit;
}

export interface BooksMagazinesMinimumRecommendedAge {
	measure?: number;
	unit?: MaximumRecommendedAgeUnit;
}

export interface BooksMagazinesSwatchImage {
	swatchImageUrl?: string;
	swatchVariantAttribute?: BooksMagazinesVariantAttributeName;
}

export enum BooksMagazinesVariantAttributeName {
	BookFormat = 'bookFormat',
	Edition = 'edition',
}
...
export interface HomeDecorKitchenOther {
	...
	character?: string[];
	cleaningCareAndMaintenance?: string;
	clockNumberType?: DialMarkerType;
	collection?: string;
	color?: string[];
	colorCategory?: ColorCategory[];
	compositeWoodCertificationCode?: CompositeWoodCertificationCode;
...
export enum DialMarkerType {
	ArabicStandard = 'Arabic/Standard',
...
export interface Movies {
	...
	title?: string;
	variantAttributeNames?: MoviesVariantAttributeName[];
	variantGroupId?: string;
}
...
export interface MoviesDuration {
	measure?: number;
	unit?: DurationUnit;
}
...
export interface MoviesSwatchImage {
	swatchImageUrl?: string;
	swatchVariantAttribute?: MoviesVariantAttributeName;
}

export enum MoviesVariantAttributeName {
	Edition = 'edition',
...
export interface TVShows {
	actors?: string[];
	additionalProductAttributes?: TVShowsAdditionalProductAttribute[];
	aspectRatio?: string;
	athlete?: string[];
	audioTrackCodec?: string;
	awardsWon?: string[];
	character?: string[];
	count?: string;
	countPerPack?: number;
	...
	studioProductionCompany?: string;
	subtitledLanguages?: string[];
	swatchImages?: TVShowsSwatchImage[];
	synopsis?: string;
	targetAudience?: string[];
	title?: string;
	tvNetwork?: string;
	...
	tvShowGenre?: string;
	tvShowSeason?: string;
	tvShowSubgenre?: string;
	variantAttributeNames?: TVShowsVariantAttributeName[];
	variantGroupId?: string;
}

export interface TVShowsAdditionalProductAttribute {
	productAttributeName: string;
	productAttributeValue: string;
}

export interface TVShowsDuration {
	measure?: number;
	unit?: DurationUnit;
}

export interface TVShowsSwatchImage {
	swatchImageUrl?: string;
	swatchVariantAttribute?: TVShowsVariantAttributeName;
}

export enum TVShowsVariantAttributeName {
	Count = 'count',
	CountPerPack = 'countPerPack',
	Edition = 'edition',
	PhysicalMediaFormat = 'physicalMediaFormat',
...
export interface Tires {
	additionalProductAttributes?: TiresAdditionalProductAttribute[];
	assembledProductWeight?: TiresAssembledProductWeight;
	color?: string[];
	...
	features?: string[];
	isPrimaryVariant?: MustShipAlone;
	isRunFlat?: MustShipAlone;
	keyFeatures?: string[];
	mainImageUrl: string;
	manufacturer?: string;
	manufacturerPartNumber?: string;
	maximumInflationPressure?: MaximumInflationPressure;
	modelNumber?: string;
	msrp?: number;
	mudAndSnowRated?: MustShipAlone;
	overallDiameter?: OverallDiameter;
	productSecondaryImageURL?: string[];
	prop65WarningText?: string;
	shortDescription: string;
	swatchImages?: TiresSwatchImage[];
	tireAspectRatio?: number;
	tireLoadIndex?: number;
	tireLoadRange?: TireLoadRange;
	tireSeason?: string;
	tireSidewallStyle?: string;
	tireSize: string;
	tireSpeedRating?: string;
	tireTemperatureRating?: TireTemperatureRating;
	tireTractionRating?: TireTractionRating;
	tireTreadwearRating?: number;
	tireType?: string;
	tireWidth?: number;
	treadDepth?: TreadDepth;
	treadWidth?: TreadWidth;
	uniformTireQualityGrade?: string;
	variantAttributeNames?: TiresVariantAttributeName[];
	variantGroupId?: string;
	vehicleClassDesignator?: string;
	vehicleType?: string;
	warrantyText?: string;
	warrantyURL?: string;
...
export interface TiresAdditionalProductAttribute {
	productAttributeName: string;
	productAttributeValue: string;
}

export interface TiresAssembledProductWeight {
	measure?: number;
	unit?: AssembledProductWeightUnit;
}

export interface MaximumInflationPressure {
	measure?: number;
	unit?: WorkingPressureUnit;
}

export interface OverallDiameter {
	measure?: number;
	unit?: ScreenSizeUnit;
}

export interface TiresSwatchImage {
	swatchImageUrl?: string;
	swatchVariantAttribute?: TiresVariantAttributeName;
}

export enum TiresVariantAttributeName {
	Color = 'color',
	Count = 'count',
	Diameter = 'diameter',
	Size = 'size',
...
export enum TireTemperatureRating {
	A = 'A',
	B = 'B',
	C = 'C',
}

export enum TireTractionRating {
	A = 'A',
	Aa = 'AA',
	B = 'B',
	C = 'C',
...
export interface WatercraftSwatchImage {
	swatchImageUrl?: string;
	swatchVariantAttribute?: SwatchVariantAttribute6;
}

export enum SwatchVariantAttribute6 {
	Color = 'color',
	EngineModel = 'engineModel',
	VehicleMake = 'vehicleMake',
	VehicleModel = 'vehicleModel',
...
export class Convert {
	public static toMpItem43(json: string): MpItem43 {
		return cast(JSON.parse(json), r('MpItem43'));
	}

	public static mpItem43ToJson(value: MpItem43): string {
		return JSON.stringify(uncast(value, r('MpItem43')), null, 2);
	}
}
...
const typeMap: any = {
	...
	Orderable: o(
		[
			...
			{
				json: 'batteryTechnologyType',
				js: 'batteryTechnologyType',
				typ: u(undefined, r('ContainedBatteryType')),
			},
			{ json: 'brand', js: 'brand', typ: '' },
			{ json: 'chemicalAerosolPesticide', js: 'chemicalAerosolPesticide', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'electronicsIndicator', js: 'electronicsIndicator', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'endDate', js: 'endDate', typ: u(undefined, Date) },
			{
				json: 'externalProductIdentifier',
				js: 'externalProductIdentifier',
				typ: u(undefined, a(r('ExternalProductIdentifier'))),
			},
			{ json: 'fulfillmentLagTime', js: 'fulfillmentLagTime', typ: u(undefined, 0) },
			{ json: 'multipackQuantity', js: 'multipackQuantity', typ: u(undefined, 0) },
			{ json: 'MustShipAlone', js: 'MustShipAlone', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'price', js: 'price', typ: 3.14 },
			{ json: 'pricePerUnit', js: 'pricePerUnit', typ: u(undefined, r('PricePerUnit')) },
			{ json: 'productIdentifiers', js: 'productIdentifiers', typ: r('ProductIdentifiers') },
			{ json: 'ProductIdUpdate', js: 'ProductIdUpdate', typ: u(undefined, r('MustShipAlone')) },
	...
	ExternalProductIdentifier: o(
		[
			{ json: 'externalProductId', js: 'externalProductId', typ: '' },
			{ json: 'externalProductIdType', js: 'externalProductIdType', typ: r('ExternalProductIDType') },
		],
		false
	),
	PricePerUnit: o(
		[
			{ json: 'pricePerUnitQuantity', js: 'pricePerUnitQuantity', typ: u(undefined, 3.14) },
			{ json: 'pricePerUnitUom', js: 'pricePerUnitUom', typ: u(undefined, r('PPUUnitOfMeasure')) },
		],
		false
	),
	...
	Visible: o(
		[
			...
			{ json: 'Books & Magazines', js: 'Books & Magazines', typ: u(undefined, r('BooksMagazines')) },
			...
			{ json: 'Tires', js: 'Tires', typ: u(undefined, r('Tires')) },
			...
			{ json: 'TV Shows', js: 'TV Shows', typ: u(undefined, r('TVShows')) },
	...
	AnimalAccessories: o(
		[
			...
			{
				json: 'countryOfOriginTextiles',
				js: 'countryOfOriginTextiles',
				typ: u(undefined, r('CountryOfOriginTextiles')),
			},
			...
			{ json: 'prop65WarningText', js: 'prop65WarningText', typ: u(undefined, '') },
	...
	AnimalFood: o(
		[
			...
			{ json: 'isPrimaryVariant', js: 'isPrimaryVariant', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'labelImage', js: 'labelImage', typ: u(undefined, a(r('AnimalFoodLabelImage'))) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
	...
	AnimalFoodLabelImage: o(
		[
			{ json: 'labelImageContains', js: 'labelImageContains', typ: u(undefined, r('LabelImageContains')) },
			{ json: 'labelImageURL', js: 'labelImageURL', typ: u(undefined, '') },
		],
		false
	),
	...
	AnimalHealthGrooming: o(
		[
			...
			{ json: 'isRetractable', js: 'isRetractable', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'labelImage', js: 'labelImage', typ: u(undefined, a(r('AnimalHealthGroomingLabelImage'))) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
			{ json: 'manufacturerPartNumber', js: 'manufacturerPartNumber', typ: u(undefined, '') },
	...
	ArtCraft: o(
		[
			...
			{ json: 'smallPartsWarnings', js: 'smallPartsWarnings', typ: u(undefined, a(r('SmallPartsWarningCode'))) },
	...
	BabyDiaperingCareOther: o(
		[
			...
			{ json: 'isPrimaryVariant', js: 'isPrimaryVariant', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'labelImage', js: 'labelImage', typ: u(undefined, a(r('BabyDiaperingCareOtherLabelImage'))) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
			{ json: 'manufacturerPartNumber', js: 'manufacturerPartNumber', typ: u(undefined, '') },
			{ json: 'material', js: 'material', typ: u(undefined, a('')) },
	...
	BabyFood: o(
		[
			...
			{ json: 'isPrimaryVariant', js: 'isPrimaryVariant', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'labelImage', js: 'labelImage', typ: u(undefined, a(r('BabyFoodLabelImage'))) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
			{
				json: 'maximumRecommendedAge',
	...
	BeautyPersonalCareHygiene: o(
		[
			...
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'labelImage', js: 'labelImage', typ: u(undefined, a(r('BeautyPersonalCareHygieneLabelImage'))) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
	...
	BooksMagazines: o(
		[
			{ json: 'additionalBISACSubjectCodes', js: 'additionalBISACSubjectCodes', typ: u(undefined, a('')) },
			{
				json: 'additionalProductAttributes',
				js: 'additionalProductAttributes',
				typ: u(undefined, a(r('BooksMagazinesAdditionalProductAttribute'))),
			},
			{ json: 'alternateTitle', js: 'alternateTitle', typ: u(undefined, a('')) },
			{ json: 'author', js: 'author', typ: u(undefined, a('')) },
			{ json: 'awardsWon', js: 'awardsWon', typ: u(undefined, a('')) },
			{ json: 'bisacSubjectCodes', js: 'bisacSubjectCodes', typ: u(undefined, a('')) },
			{ json: 'bookFormat', js: 'bookFormat', typ: u(undefined, r('BookFormat')) },
			{ json: 'edition', js: 'edition', typ: u(undefined, '') },
			{ json: 'editor', js: 'editor', typ: u(undefined, '') },
			{ json: 'illustrator', js: 'illustrator', typ: u(undefined, '') },
			{ json: 'ISBN-13', js: 'ISBN-13', typ: u(undefined, a('')) },
			{ json: 'isLargePrint', js: 'isLargePrint', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'isPrimaryVariant', js: 'isPrimaryVariant', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'issue', js: 'issue', typ: u(undefined, '') },
			{ json: 'isUnabridged', js: 'isUnabridged', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{
				json: 'maximumRecommendedAge',
				js: 'maximumRecommendedAge',
				typ: u(undefined, r('BooksMagazinesMaximumRecommendedAge')),
			},
			{
				json: 'minimumRecommendedAge',
				js: 'minimumRecommendedAge',
				typ: u(undefined, r('BooksMagazinesMinimumRecommendedAge')),
			},
			{ json: 'msrp', js: 'msrp', typ: u(undefined, 3.14) },
			{ json: 'numberInSeries', js: 'numberInSeries', typ: u(undefined, '') },
			{ json: 'numberOfDiscs', js: 'numberOfDiscs', typ: u(undefined, 0) },
			{ json: 'numberOfPages', js: 'numberOfPages', typ: u(undefined, 0) },
			{ json: 'originalLanguages', js: 'originalLanguages', typ: u(undefined, a('')) },
			{ json: 'productSecondaryImageURL', js: 'productSecondaryImageURL', typ: u(undefined, a('')) },
			{ json: 'prop65WarningText', js: 'prop65WarningText', typ: u(undefined, '') },
			{ json: 'publicationDate', js: 'publicationDate', typ: u(undefined, Date) },
			{ json: 'publisher', js: 'publisher', typ: u(undefined, '') },
			{ json: 'readingLevel', js: 'readingLevel', typ: u(undefined, '') },
			{ json: 'seriesTitle', js: 'seriesTitle', typ: u(undefined, '') },
			{ json: 'shortDescription', js: 'shortDescription', typ: '' },
			{ json: 'swatchImages', js: 'swatchImages', typ: u(undefined, a(r('BooksMagazinesSwatchImage'))) },
			{ json: 'title', js: 'title', typ: u(undefined, '') },
			{ json: 'translatedFrom', js: 'translatedFrom', typ: u(undefined, '') },
			{ json: 'translator', js: 'translator', typ: u(undefined, '') },
			{
				json: 'variantAttributeNames',
				js: 'variantAttributeNames',
				typ: u(undefined, a(r('BooksMagazinesVariantAttributeName'))),
			},
			{ json: 'variantGroupId', js: 'variantGroupId', typ: u(undefined, '') },
		],
		false
	),
	BooksMagazinesAdditionalProductAttribute: o(
		[
			{ json: 'productAttributeName', js: 'productAttributeName', typ: '' },
			{ json: 'productAttributeValue', js: 'productAttributeValue', typ: '' },
		],
	...
	BooksMagazinesMaximumRecommendedAge: o(
		[
			{ json: 'measure', js: 'measure', typ: u(undefined, 0) },
			{ json: 'unit', js: 'unit', typ: u(undefined, r('MaximumRecommendedAgeUnit')) },
		],
	...
	BooksMagazinesMinimumRecommendedAge: o(
		[
			{ json: 'measure', js: 'measure', typ: u(undefined, 0) },
			{ json: 'unit', js: 'unit', typ: u(undefined, r('MaximumRecommendedAgeUnit')) },
		],
	...
	BooksMagazinesSwatchImage: o(
		[
			{ json: 'swatchImageUrl', js: 'swatchImageUrl', typ: u(undefined, '') },
			{
				json: 'swatchVariantAttribute',
				js: 'swatchVariantAttribute',
				typ: u(undefined, r('BooksMagazinesVariantAttributeName')),
			},
		],
		false
	),
	...
	FoodBeverage: o(
		[
			...
			{ json: 'isPrimaryVariant', js: 'isPrimaryVariant', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'labelImage', js: 'labelImage', typ: u(undefined, a(r('FoodBeverageLabelImage'))) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
			{ json: 'meal', js: 'meal', typ: u(undefined, '') },
	...
	HomeDecorKitchenOther: o(
		[
			...
			{ json: 'character', js: 'character', typ: u(undefined, a('')) },
			{ json: 'cleaningCareAndMaintenance', js: 'cleaningCareAndMaintenance', typ: u(undefined, '') },
			{ json: 'clockNumberType', js: 'clockNumberType', typ: u(undefined, r('DialMarkerType')) },
			{ json: 'collection', js: 'collection', typ: u(undefined, '') },
			{ json: 'color', js: 'color', typ: u(undefined, a('')) },
			{ json: 'colorCategory', js: 'colorCategory', typ: u(undefined, a(r('ColorCategory'))) },
			{
	...
	HouseholdCleaningProductsSupplies: o(
		[
			...
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{
				json: 'labelImage',
				js: 'labelImage',
				typ: u(undefined, a(r('HouseholdCleaningProductsSuppliesLabelImage'))),
			},
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
			{ json: 'manufacturerPartNumber', js: 'manufacturerPartNumber', typ: u(undefined, '') },
	...
	MedicineSupplements: o(
		[
			...
			{ json: 'isPrimaryVariant', js: 'isPrimaryVariant', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'labelImage', js: 'labelImage', typ: u(undefined, a(r('MedicineSupplementsLabelImage'))) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
			{ json: 'medicineStrength', js: 'medicineStrength', typ: u(undefined, '') },
			{ json: 'msrp', js: 'msrp', typ: u(undefined, 3.14) },
	...
	Movies: o(
		[
			...
			{ json: 'duration', js: 'duration', typ: u(undefined, r('MoviesDuration')) },
			{ json: 'edition', js: 'edition', typ: u(undefined, '') },
			...
			{ json: 'mpaaRating', js: 'mpaaRating', typ: r('MPAARating') },
			{ json: 'msrp', js: 'msrp', typ: u(undefined, 3.14) },
			{ json: 'numberInSeries', js: 'numberInSeries', typ: u(undefined, '') },
			{ json: 'numberOfDiscs', js: 'numberOfDiscs', typ: u(undefined, 0) },
			{ json: 'originalLanguages', js: 'originalLanguages', typ: u(undefined, a('')) },
			...
			{ json: 'title', js: 'title', typ: u(undefined, '') },
			{
				json: 'variantAttributeNames',
				js: 'variantAttributeNames',
				typ: u(undefined, a(r('MoviesVariantAttributeName'))),
			},
			{ json: 'variantGroupId', js: 'variantGroupId', typ: u(undefined, '') },
		],
		false
	...
	MoviesSwatchImage: o(
		[
			{ json: 'swatchImageUrl', js: 'swatchImageUrl', typ: u(undefined, '') },
			{
				json: 'swatchVariantAttribute',
				js: 'swatchVariantAttribute',
				typ: u(undefined, r('MoviesVariantAttributeName')),
			},
		],
		false
	),
	...
	TVShows: o(
		[
			{ json: 'actors', js: 'actors', typ: u(undefined, a('')) },
			{
				json: 'additionalProductAttributes',
				js: 'additionalProductAttributes',
				typ: u(undefined, a(r('TVShowsAdditionalProductAttribute'))),
			},
			{ json: 'aspectRatio', js: 'aspectRatio', typ: u(undefined, '') },
			{ json: 'athlete', js: 'athlete', typ: u(undefined, a('')) },
			{ json: 'audioTrackCodec', js: 'audioTrackCodec', typ: u(undefined, '') },
			{ json: 'awardsWon', js: 'awardsWon', typ: u(undefined, a('')) },
			{ json: 'character', js: 'character', typ: u(undefined, a('')) },
			{ json: 'count', js: 'count', typ: u(undefined, '') },
			{ json: 'countPerPack', js: 'countPerPack', typ: u(undefined, 0) },
			{ json: 'director', js: 'director', typ: u(undefined, '') },
			{ json: 'dubbedLanguages', js: 'dubbedLanguages', typ: u(undefined, a('')) },
			{ json: 'duration', js: 'duration', typ: u(undefined, r('TVShowsDuration')) },
			{ json: 'dvdReleaseDate', js: 'dvdReleaseDate', typ: u(undefined, Date) },
			{ json: 'edition', js: 'edition', typ: u(undefined, '') },
			{ json: 'episode', js: 'episode', typ: u(undefined, '') },
			{ json: 'features', js: 'features', typ: u(undefined, a('')) },
			{ json: 'hasSubtitles', js: 'hasSubtitles', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'isAdultProduct', js: 'isAdultProduct', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'isDubbed', js: 'isDubbed', typ: u(undefined, r('MustShipAlone')) },
			...
			{ json: 'numberInSeries', js: 'numberInSeries', typ: u(undefined, '') },
			{ json: 'numberOfDiscs', js: 'numberOfDiscs', typ: u(undefined, 0) },
			{ json: 'numberOfEpisodes', js: 'numberOfEpisodes', typ: u(undefined, 0) },
			{ json: 'originalLanguages', js: 'originalLanguages', typ: u(undefined, a('')) },
			{
				json: 'physicalMediaFormat',
				js: 'physicalMediaFormat',
			...
			{ json: 'studioProductionCompany', js: 'studioProductionCompany', typ: u(undefined, '') },
			{ json: 'subtitledLanguages', js: 'subtitledLanguages', typ: u(undefined, a('')) },
			{ json: 'swatchImages', js: 'swatchImages', typ: u(undefined, a(r('TVShowsSwatchImage'))) },
			{ json: 'synopsis', js: 'synopsis', typ: u(undefined, '') },
			{ json: 'targetAudience', js: 'targetAudience', typ: u(undefined, a('')) },
			{ json: 'title', js: 'title', typ: u(undefined, '') },
			{ json: 'tvNetwork', js: 'tvNetwork', typ: u(undefined, '') },
			{ json: 'tvRating', js: 'tvRating', typ: '' },
			{ json: 'tvShowGenre', js: 'tvShowGenre', typ: u(undefined, '') },
			{ json: 'tvShowSeason', js: 'tvShowSeason', typ: u(undefined, '') },
			{ json: 'tvShowSubgenre', js: 'tvShowSubgenre', typ: u(undefined, '') },
			{
				json: 'variantAttributeNames',
				js: 'variantAttributeNames',
				typ: u(undefined, a(r('TVShowsVariantAttributeName'))),
			},
			{ json: 'variantGroupId', js: 'variantGroupId', typ: u(undefined, '') },
		],
		false
	),
	TVShowsAdditionalProductAttribute: o(
		[
			{ json: 'productAttributeName', js: 'productAttributeName', typ: '' },
			{ json: 'productAttributeValue', js: 'productAttributeValue', typ: '' },
		],
	...
	TVShowsSwatchImage: o(
		[
			{ json: 'swatchImageUrl', js: 'swatchImageUrl', typ: u(undefined, '') },
			{
				json: 'swatchVariantAttribute',
				js: 'swatchVariantAttribute',
				typ: u(undefined, r('TVShowsVariantAttributeName')),
			},
		],
		false
	),
		...
		[
			{
				json: 'additionalProductAttributes',
				js: 'additionalProductAttributes',
				typ: u(undefined, a(r('TiresAdditionalProductAttribute'))),
			},
			{
				json: 'assembledProductWeight',
				js: 'assembledProductWeight',
				typ: u(undefined, r('TiresAssembledProductWeight')),
			},
			{ json: 'color', js: 'color', typ: u(undefined, a('')) },
			{ json: 'constructionType', js: 'constructionType', typ: u(undefined, '') },
			{ json: 'count', js: 'count', typ: u(undefined, '') },
			{ json: 'countPerPack', js: 'countPerPack', typ: u(undefined, 0) },
			{ json: 'features', js: 'features', typ: u(undefined, a('')) },
			{ json: 'isPrimaryVariant', js: 'isPrimaryVariant', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'isRunFlat', js: 'isRunFlat', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'keyFeatures', js: 'keyFeatures', typ: u(undefined, a('')) },
			{ json: 'mainImageUrl', js: 'mainImageUrl', typ: '' },
			{ json: 'manufacturer', js: 'manufacturer', typ: u(undefined, '') },
			{ json: 'manufacturerPartNumber', js: 'manufacturerPartNumber', typ: u(undefined, '') },
			{
				json: 'maximumInflationPressure',
				js: 'maximumInflationPressure',
				typ: u(undefined, r('MaximumInflationPressure')),
			},
			{ json: 'modelNumber', js: 'modelNumber', typ: u(undefined, '') },
			{ json: 'msrp', js: 'msrp', typ: u(undefined, 3.14) },
			{ json: 'mudAndSnowRated', js: 'mudAndSnowRated', typ: u(undefined, r('MustShipAlone')) },
			{ json: 'overallDiameter', js: 'overallDiameter', typ: u(undefined, r('OverallDiameter')) },
			{ json: 'productSecondaryImageURL', js: 'productSecondaryImageURL', typ: u(undefined, a('')) },
			{ json: 'prop65WarningText', js: 'prop65WarningText', typ: u(undefined, '') },
			{ json: 'shortDescription', js: 'shortDescription', typ: '' },
			{ json: 'swatchImages', js: 'swatchImages', typ: u(undefined, a(r('TiresSwatchImage'))) },
			{ json: 'tireAspectRatio', js: 'tireAspectRatio', typ: u(undefined, 0) },
			{ json: 'tireLoadIndex', js: 'tireLoadIndex', typ: u(undefined, 0) },
			{ json: 'tireLoadRange', js: 'tireLoadRange', typ: u(undefined, r('TireLoadRange')) },
			{ json: 'tireSeason', js: 'tireSeason', typ: u(undefined, '') },
			{ json: 'tireSidewallStyle', js: 'tireSidewallStyle', typ: u(undefined, '') },
			{ json: 'tireSize', js: 'tireSize', typ: '' },
			{ json: 'tireSpeedRating', js: 'tireSpeedRating', typ: u(undefined, '') },
			{
				json: 'tireTemperatureRating',
				js: 'tireTemperatureRating',
				typ: u(undefined, r('TireTemperatureRating')),
			},
			{ json: 'tireTractionRating', js: 'tireTractionRating', typ: u(undefined, r('TireTractionRating')) },
			{ json: 'tireTreadwearRating', js: 'tireTreadwearRating', typ: u(undefined, 0) },
			{ json: 'tireType', js: 'tireType', typ: u(undefined, '') },
			{ json: 'tireWidth', js: 'tireWidth', typ: u(undefined, 0) },
			{ json: 'treadDepth', js: 'treadDepth', typ: u(undefined, r('TreadDepth')) },
			{ json: 'treadWidth', js: 'treadWidth', typ: u(undefined, r('TreadWidth')) },
			{ json: 'uniformTireQualityGrade', js: 'uniformTireQualityGrade', typ: u(undefined, '') },
			{
				json: 'variantAttributeNames',
				js: 'variantAttributeNames',
				typ: u(undefined, a(r('TiresVariantAttributeName'))),
			},
			{ json: 'variantGroupId', js: 'variantGroupId', typ: u(undefined, '') },
			{ json: 'vehicleClassDesignator', js: 'vehicleClassDesignator', typ: u(undefined, '') },
			{ json: 'vehicleType', js: 'vehicleType', typ: u(undefined, '') },
			{ json: 'warrantyText', js: 'warrantyText', typ: u(undefined, '') },
			{ json: 'warrantyURL', js: 'warrantyURL', typ: u(undefined, '') },
			{ json: 'wheelDiameter', js: 'wheelDiameter', typ: u(undefined, r('WheelDiameter')) },
		],
		false
	),
	TiresAdditionalProductAttribute: o(
		[
			{ json: 'productAttributeName', js: 'productAttributeName', typ: '' },
			{ json: 'productAttributeValue', js: 'productAttributeValue', typ: '' },
		],
	...
	TiresSwatchImage: o(
		[
			{ json: 'swatchImageUrl', js: 'swatchImageUrl', typ: u(undefined, '') },
			{
				json: 'swatchVariantAttribute',
				js: 'swatchVariantAttribute',
				typ: u(undefined, r('TiresVariantAttributeName')),
			},
		],
		false
	),
	...
	WatercraftSwatchImage: o(
		[
			{ json: 'swatchImageUrl', js: 'swatchImageUrl', typ: u(undefined, '') },
			{
				json: 'swatchVariantAttribute',
				js: 'swatchVariantAttribute',
				typ: u(undefined, r('SwatchVariantAttribute6')),
			},
		],
		false
	),
	...
	PPUUnitOfMeasure: ['Cubic Foot', 'Each', 'Fluid Ounce', 'Foot', 'Inch', 'Ounce', 'Pound', 'Square Foot', 'Yard'],
	...
	BookFormat: ['Audiobook', 'Board Book', 'eBook', 'Hardcover', 'Library Binding', 'Other', 'Paperback'],
	BooksMagazinesVariantAttributeName: ['bookFormat', 'edition'],
	...
	HilariousSwatchVariantAttribute: ['color', 'count', 'countPerPack', 'platform', 'resolution', 'size'],
	ElectronicsOtherVariantAttributeName: [
		'color',
		'count',
		'countPerPack',
		'hardDriveCapacity',
	...
	MischievousSwatchVariantAttribute: [
		'academicInstitution',
		'accentColor',
		'assembledProductHeight',
		'assembledProductLength',
	...
	BraggadociousSwatchVariantAttribute: ['count', 'countPerPack', 'flavor', 'medicineStrength', 'size'],
	...
	MoviesVariantAttributeName: ['edition', 'physicalMediaFormat'],
	...
	SwatchVariantAttribute1: ['color', 'count', 'countPerPack', 'resolution', 'size'],
	...
	TVShowsVariantAttributeName: ['count', 'countPerPack', 'edition', 'physicalMediaFormat', 'sportsTeam'],
	RefreshRateUnit: ['Hz'],
	TentacledUnit: ['ms'],
	SwatchVariantAttribute3: [
		'color',
		'configuration',
		'count',
		'countPerPack',
	...
	TiresVariantAttributeName: ['color', 'count', 'diameter', 'size'],
	TireLoadRange: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'L', 'M', 'N'],
	TireTemperatureRating: ['A', 'B', 'C'],
	TireTractionRating: ['A', 'AA', 'B', 'C'],
	...
	SwatchVariantAttribute5: ['count', 'countPerPack', 'mountType', 'resolution', 'screenSize', 'size'],
	...
	SwatchVariantAttribute6: ['color', 'engineModel', 'vehicleMake', 'vehicleModel', 'vehicleYear'],
