...
import { ReturnsRefundsApiApi, ReturnsRefundsApiFactory } from '../../../src/apis/returns';
...
describe('returns', () => {
	let returnsConfiguration: Configuration;
	...
	beforeAll(async () => {
		...
		returnsConfiguration = new Configuration({ accessToken });
	});
